...
function ReportInProgress() {
    ...
    return (
        <div>
            <h1>Task In Progress by Agent (Manager Report)</h1> {/* Add the header here */}
            ...
            <div style={{ display: 'flex' }}>
                ...
                <div style={{ flex: 1, padding: '10px', overflow: 'auto', borderRadius: '10px', border: '2px solid black', margin: '5px', backgroundColor: '#BFBAF0', height: '680px' }}>
                    ...
                    <div style={{ marginTop: '10px' }}>
                        ...
                        <div style={{ border: '2px solid black', padding: '5px', overflow: 'auto', backgroundColor: 'white',  height: '150px' }}>
