...
class InProgressDetailsPage extends StatefulWidget {
  ...
  const InProgressDetailsPage({Key? key, required this.data}) : super(key: key);

  @override
  State<InProgressDetailsPage> createState() => _InProgressDetailsPageState();
}
...
class _InProgressDetailsPageState extends State<InProgressDetailsPage> {
  @override
