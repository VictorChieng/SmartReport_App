...
import 'package:fyptest1/InProgreessDetailsPage.dart';
...
class InProgressPage extends StatefulWidget {
  final String userId;
  const InProgressPage({Key? key, required this.userId}) : super(key: key);
      ...
      body: Container(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
              ...
              .where('reportStatus', isEqualTo: "In Progress")
              .snapshots(),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  InProgressDetailsPage(data: document,)));
                    },
                    child: Card(
                      child: Stack(
                        children: [
